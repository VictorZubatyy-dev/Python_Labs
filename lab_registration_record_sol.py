...
# date: 18-11-2020
# purpose: A solution to the exercise on composition usage
# also contains docstring usage
# also contains use of properties
...
class Student:
    ...
    def get_all_student_data(self):
        return self.__f_name, self.__l_name, self.__study_type, self.__courses
...
class RegistrationData:
    ...
    def __init__(self, address, registration_fee, study_type, f_name, l_name, s_id="NA"):
        ...
        try:
            ...
            print("issue creating the student object for registration: ", e)


    @property
    def student_object_property(self):
        # could do checks here on who the caller is or restrict to certain times
        # business rules checking to protect access to the student object
    ...
    def display_student_data(self):
        print("Student Info: ", self.__student_obj.get_all_student_data(), self.__s_id)
        print("Address: ", self.__address)
        print("Registration fee: ", self.__registration_fee)



# there are several raise statements in the above solution.
# You should enclose these section with a try...except down here
# in order to facilitate a graceful exit.
